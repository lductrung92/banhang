...
StyleSwitcher.prototype.build = function() {
    ...
    var h5 = $('<h5 />').html('Thiết lập').append(h5A).before('ádasdsa');
...
var info = '<ul><li style = "color: white" >' + navigator.sayswho + ' </li>' +
    '</ul>';

$('#style-switcher .style-switcher-wrap h6').first().before(info);