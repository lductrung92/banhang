<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-header">
        <a class="navbar-brand" href="index.html"><img src="assets/plugin/assets/images/logo_light.png" alt=""></a>
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left"><img src="assets/plugin/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
                            <div class="media-body">
                                <a href="#" class="media-heading">
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    <img src="assets/plugin/assets/images/placeholder.jpg" alt="">
                    <span>Victoria</span>
                    <i class="caret"></i>
                </a>
